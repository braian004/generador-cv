...
export const TEMPLATE_OPTIONS: { id: TemplateId; label: string; badge: string; desc: string }[] = [
  ...
  { id: 'elegante-lujo', label: '👑 Elegante & Lujo', badge: 'Alta Gama', desc: 'Cabecera dorada y refinada con la mejor presencia profesional' },
  { id: 'fresca-vibrante', label: '🌈 Fresco & Vibrante', badge: 'Creativo', desc: 'Tarjetas destacadas con badges redondeados y acentos modernos' },
  { id: 'minimalista-pro', label: '⚡ Minimalista Pro', badge: 'Ultra Limpio', desc: 'Máxima claridad ATS con jerarquía tipográfica perfecta' },
